...
public class TestClienteConPedidoPendienteException {
	...
	@Test
	public void test() throws SinVehiculoParaPedidoException, ClienteNoExisteException, ClienteConViajePendienteException, PedidoInexistenteException, ChoferNoDisponibleException, VehiculoNoDisponibleException, VehiculoNoValidoException {
		try {
	        empresa.agregarPedido(pedido1);
	        empresa.crearViaje(pedido1, chofer1, auto1);
	        empresa.agregarPedido(pedido2);
			fail("Se esperaba que salte la excepcion ClienteConPedidoPendienteException");
